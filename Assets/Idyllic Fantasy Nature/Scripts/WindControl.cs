...
namespace IdyllicFantasyNature
{
    ...
    {
        [Range(0, 1)] [SerializeField] private float _windStrength;

        [Range(0, 1)] [SerializeField] private float _windSpeed;

        [Range(0, 1)] [SerializeField] private float _windVariation;

        [Range(0, 1)] [Tooltip("how detailed the wind moves the object")] [SerializeField]
