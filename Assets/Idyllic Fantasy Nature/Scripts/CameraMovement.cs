...
namespace IdyllicFantasyNature
{
    ...
    {
        [Range(1f, 10f)] [Tooltip("speed of the camera movement")] [SerializeField]
        private float _mouseSensity = 1;
        ...
        private void Update()
        {
            ...
            var mouseX = Input.GetAxis("Mouse X") * _mouseSensity;
            var mouseY = Input.GetAxis("Mouse Y") * _mouseSensity;
