...
namespace IdyllicFantasyNature
{
    ...
    {
        [SerializeField] private bool _enableBendFeature;

        [Tooltip("The origin where the impact on the object starts")] [SerializeField]
        private Transform _bendOrigin;

        [Range(0.3f, 1)] [Tooltip("object starts to bend when the player is at a certain distance")] [SerializeField]
        private float _startBendRange;

        [Range(0, 1)] [SerializeField] private float _bendStrength;

        [Tooltip("material of the vegetation objects")] [SerializeField]
        ...
        private void Update()
        {
            if (_enableBendFeature) moveOnVegetation();
        }
